		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.0", "10.0.2.0/24"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.1", "10.0.3.0/24"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.next_hop_ip_address", "10.0.4.5"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "address_prefix", "10.0.1.0/24"),
					resource.TestCheckResourceAttr(resourceName, "virtual_wan.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "virtual_network_connections.%", "5"),
					resource.TestCheckResourceAttr(resourceName, "virtual_network_connections.name", "testConnection"),
					resource.TestCheckResourceAttr(resourceName, "virtual_network_connections.allow_hub_to_remote_vnet_transit", "false"),
					resource.TestCheckResourceAttr(resourceName, "virtual_network_connections.allow_remote_vnet_to_use_hub_vnet_gateways", "false"),
					resource.TestCheckResourceAttr(resourceName, "virtual_network_connections.enable_internet_security", "false"),
					resource.TestCheckResourceAttr(resourceName, "route_table.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.#", "2"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.0", "10.0.2.0/24"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.address_prefixes.1", "10.0.3.0/24"),
					resource.TestCheckResourceAttr(resourceName, "route_table.routes.next_hop_ip_address", "10.0.4.6"),

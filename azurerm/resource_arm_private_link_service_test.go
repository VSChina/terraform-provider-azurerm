		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ip_configurations.%", "5"),
					resource.TestCheckResourceAttr(resourceName, "ip_configurations.private_ip_address", "10.5.1.17"),
					resource.TestCheckResourceAttr(resourceName, "ip_configurations.private_ip_address_version", "IPv4"),
					resource.TestCheckResourceAttr(resourceName, "ip_configurations.private_ipallocation_method", "Static"),

		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "route_table.routes.address_prefixes.#", "2"),
					resource.TestCheckResourceAttr(dataSourceName, "route_table.routes.address_prefixes.0", "10.0.2.0/24"),
					resource.TestCheckResourceAttr(dataSourceName, "route_table.routes.address_prefixes.1", "10.0.3.0/24"),
					resource.TestCheckResourceAttr(dataSourceName, "route_table.routes.next_hop_ip_address", "10.0.4.5"),
				),
			},
		},
	})
...
data "azurerm_virtual_hub" "test" {
  resource_group = "${azurerm_virtual_hub.test.resource_group}"

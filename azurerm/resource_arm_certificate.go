...
func resourceArmCertificate() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			// TODO: Property 'previousProvisioningStateTransitionTime' of type Api::Azure::Type::ISO8601DateTime is not supported in primitive.erb

			// TODO: Property 'provisioningStateTransitionTime' of type Api::Azure::Type::ISO8601DateTime is not supported in primitive.erb
...
func resourceArmCertificateCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if requireResourcesToBeImported {
		...
		if !utils.ResponseWasNotFound(resp.Response) {
			return tf.ImportAsExistsError("azurerm_certificate", *resp.ID)
		}
	}
...
func resourceArmCertificateRead(d *schema.ResourceData, meta interface{}) error {
	...
	if certificateCreateOrUpdateProperties := resp.CertificateCreateOrUpdateProperties; certificateCreateOrUpdateProperties != nil {
		...
		// TODO: SDK Reference /properties/previousProvisioningStateTransitionTime is not supported
		// TODO: SDK Reference /properties/provisioningStateTransitionTime is not supported

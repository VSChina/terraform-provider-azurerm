		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "private_link_service_connections.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "private_link_service_connections.0.name", "<%= get_resource_name('privatelinkservice', 'connection') -%>"),
				),
			},
			{
...
func testCheckAzureRMPrivateEndpointExists(resourceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if resp, err := client.Get(ctx, resourceGroup, name, ""); err != nil {
			...
			return fmt.Errorf("Bad: Get on network.PrivateEndpointClient: %+v", err)
		}
